...
plant_species <- dbGetQuery(con, "SELECT DISTINCT genus, specific_epithet FROM plant LIMIT 10")
print(plant_species)
...
SELECT
  ...
  p.specific_epithet
FROM chamber_wp pc
JOIN plant p ON pc.dataset_name = p.dataset_name AND pc.individual_id = p.individual_id
...
SELECT
  ...
  p.specific_epithet
FROM auto_wp a
JOIN plant p ON a.dataset_name = p.dataset_name AND a.individual_id = p.individual_id
