...
Remember to cite the appropriate data contributors when using PSInet data in your research. Dataset attribution information, including author names and ORCID IDs, can be found in the `meta` table, which joins to other tables via `dataset_name`.
