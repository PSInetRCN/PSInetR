...
3. **treatment**: Documents experimental treatments applied at study sites.

4. **plot**: Contains information about experimental plots, including vegetation type, soil properties, and terrain details.

5. **plant**: Stores data about individual plants or groups of plants, including species information, size measurements, and plant social status.

6. **sapfluxnet**: Links to SapFluxNet data for cross-network compatibility.

7. **addtl_data**: Information about additional data availability across networks.
...
3. **auto_wp_sensor**: Detailed sensor information for automated measurements.

4. **soil_var**: Soil water content and soil water potential measurements.

5. **met_var**: Meteorological variables like precipitation, temperature, humidity, and radiation.

### Quality Control Tables

Each measurement table has a corresponding flag table for quality control:
- **chamber_wp_flag**, **auto_wp_flag**, **auto_wp_sensor_flag**
- **plant_flag**, **soil_var_flag**, **met_var_flag**
